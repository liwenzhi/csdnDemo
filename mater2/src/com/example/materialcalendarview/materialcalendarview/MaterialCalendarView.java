package com.example.materialcalendarview.materialcalendarview;
...
import com.example.mater2.R;
import com.example.materialcalendarview.materialcalendarview.format.*;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * {@linkplain android.support.annotation.IntDef} annotation for selection mode.
     *
    ...
    /**
     * {@linkplain android.support.annotation.IntDef} annotation for showOtherDates.
     *
    ...
    /**
     * Default tile size in DIPs. This is used in cases where there is no tile size specificed and the view is set to {@linkplain android.view.ViewGroup.LayoutParams#WRAP_CONTENT WRAP_CONTENT}
     */
    ...
    private OnMonthsChangedListener monthListener;
     ...
     * @param formatter the new formatter, null for default
     */
    public void setDayFormatter(DayFormatters formatter) {
        adapter.setDayFormatter(formatter == null ? DayFormatters.DEFAULT : formatter);
    }
    ...
    private static int getThemeAccentColor(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ECLAIR) {
            colorAttr = android.R.attr.colorActivatedHighlight;
        } else {
     ...
     * @param listener thing to be notified
     */
    public void setOnMonthChangedListener(OnMonthsChangedListener listener) {
    ...
    protected void dispatchOnRangeSelected(final CalendarDay firstDay, final CalendarDay lastDay) {
        ...
        final List<CalendarDay> days = new ArrayList<CalendarDay>();
    ...
    protected void dispatchOnMonthChanged(final CalendarDay day) {
        OnMonthsChangedListener l = monthListener;
        if (l != null) {
     ...
     * @return the appropriate size to pass to {@linkplain android.view.View#setMeasuredDimension(int, int)}
     */
